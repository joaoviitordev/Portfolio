...
const DICT: Record<Lang, Dict> = {
  pt: {
    ...
    eduSantanderTitle: 'Santander Bootcamp 2026 — AI React Front-end',
    eduSantanderBody:
  ...
  en: {
    ...
    eduSantanderTitle: 'Santander Bootcamp 2026 — AI React Front-end',
    eduSantanderBody:
      '42-hour track on React 19, Vite, JavaScript ES6 and UI/UX Design. Final project: an intelligent financial educator, with a diagnosis generated by the Gemini API.',
